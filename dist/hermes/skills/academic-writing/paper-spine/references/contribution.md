...
2. Present the drafted Core contribution and Claim Boundary to the user and revise until they confirm — like the motivation, the contract is *confirmed* by the user, not self-declared.
3. Run `python scripts/contribution_check.py paper_rewriting_output` until it passes (exit 0).
